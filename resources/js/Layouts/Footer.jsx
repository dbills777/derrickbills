...
export default function Footer() {
    return (
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
            ...
            <footer className="footer px-10 py-4 border-t bg-background  text-base-content border-base-300 ">
                ...
                <div className="absolute bottom-0 right-0 z-10 select-none">
                    ...
                    />
                    <a
                        className="absolute inset-0 z-20 flex h-full w-full flex-col items-end justify-end"
                        href="/react"
                    >
                        <div className="group relative">
                            {/* <div className="group flex  space-x-1 items-center justify-center gap-1 transition  ease-in-out pr-4  l:pr-3 l:pb-3 duration-300 l:hover:scale-105">
                                ...
                                <LaravelLogo
                                    ...
                                    fill="currentColor"
                                />
                                <small className="relative -right-1 font-operator text-8pt italic small text-white">
                                   +
                                </small>
                                <ReactLogo
                                    size={35}
